...
(function ($) {
    ...
    $(document).on('ready', function () {
        ...
        $(document).on('click','.side-menu-wrap .side-menu-ul .sidenav__item .menu-plus-icon', function () {
            $(this).closest('.sidenav__item').siblings().removeclassName('active').find('.side-sub-menu').slideUp(200);
            $(this).closest('.sidenav__item').toggleclassName('active').find('.side-sub-menu').slideToggle(200);
            return false;
        });
        ...
        $(window).on('scroll', function () {
            ...
            if($(window).scrollTop() > 0) {
                $('.header-menu-area').addclassName('header-fixed');
            }else{
                $('.header-menu-area').removeclassName('header-fixed');
            }
        ...
        $(document).on('click','.logo-right-button .side-menu-open', function () {
            $('.side-nav-container').addclassName('active');
        });

        /*=========== Mobile Menu Close Control ============*/
        $(document).on('click','.humburger-menu .side-menu-close', function () {
            $(".side-nav-container").removeclassName('active');
        });
        ...
        $('.testimonial-carousel').owlCarousel({
            ...
            smartSpeed: 500,
            autoplay: false,
            navText: ["<i className='la la-angle-left'></i>", "<i className='la la-angle-right'></i>"]
        });
        ...
        $('.homepage-slide2').owlCarousel({
            ...
            animateIn: 'fadeIn',
            navText: ["<i className='la la-caret-left'></i>", "<i className='la la-caret-right'></i>"],
        });
        ...
        $(document).on('click', '.accordion__title', function () {
            $(this).closest('.accordion-panel').siblings().removeclassName('active').find('.accordion__content').slideUp(200);
            $(this).closest('.accordion-panel').toggleclassName('active').find('.accordion__content').slideToggle(200);
            return false;
        });
        ...
        $(document).on( 'click', '.portfolio-filter li', function() {
            ...
            $('.portfolio-filter li').removeclassName('active');
